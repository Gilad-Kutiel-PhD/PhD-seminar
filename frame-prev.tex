\begin{frame}{Maximum Carpool Matching - Conclusion}
\centering
\begin{tikzpicture}[y=40mm, x=8mm, every node/.style={draw=none}, -, thick]
    ...
    \draw plot[upper] coordinates {
        (7,0.996153846)
        (8,0.95)
        (8.8,0.91)
    };

    \draw plot[unweight] coordinates {
        (7,0.6)
        (8,0.71)
        (9,0.804)
    };

    \draw plot[weight-vertex] coordinates {
        (8,0.64)
    }; 

    \draw plot[weight-edge] coordinates {
        (7,0.5)
    };

    \draw plot[unweight-cp] coordinates {
        (16,0.5)        
    };

    \draw plot[cp] coordinates {
        (16,0.33)
        (17,0.5)
    };

    \draw plot[fixed-cp] coordinates {
        (17,0.75)
    };
